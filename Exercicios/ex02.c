...
int main() {
  ...
  printf("O desvio padrão é %lf\n\n", desvioPadrao);
    ...
    int maiorNum,menorNum, posicaoMenor, posicaoMaior;
    maiorNum = -1000000, 
    menorNum = 11000000;
    ...
    printf("O maior número digitado foi %d e está na %dª posição e o menor número digitado foi %d e está na %dª posição \n\n", maiorNum,posicaoMaior, menorNum,posicaoMenor);
